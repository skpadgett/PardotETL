# Pardot Extract - tagobjects created_after='2020-07-01',created_before='2021-07-01',id_greater_than=maxid
...
#Create PardotAPI class instance
    ...
    i=0
    while i <=p.tagobjects.query(created_after='2020-07-01',created_before='2021-07-01',id_greater_than=maxid)['total_results'] -1: 
        data=p.tagobjects.query(format='json',sort_by='id',created_after='2020-07-01',created_before='2021-07-01',id_greater_than=maxid)
