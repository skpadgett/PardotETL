...
#Header to use:
V_data = '{"object": "visitor","procedure": {"name": "filter_by_updated_at","arguments": {"updated_after": "2019-07-01 00:00:01","updated_before": "2020-04-15 00:00:01"}}}'
...
#Header to use:
V_data = '{"object": "prospect","procedure": {"name": "filter_by_updated_at","arguments": {"updated_after": "2019-07-01 00:00:01","updated_before": "2020-04-15 00:00:01"}}}'
#Create Extract Request
response = requests.post('https://pi.pardot.com/api/export/version/4/do/create', headers=headers, params=params, data=V_data)
# Get assigned export id
response_dict=json.loads(response.text)
...
#Header to use:
V_data = '{"object": "prospectaccount","procedure": {"name": "filter_by_prospect_updated_at","arguments": {"prospect_updated_after": "2019-07-01 00:00:01","prospect_updated_before": "2020-04-15 00:00:01"}}}'	
#Create Extract Request
response = requests.post('https://pi.pardot.com/api/export/version/4/do/create', headers=headers, params=params, data=V_data)
# Get assigned export id
response_dict=json.loads(response.text)
...
#Header to use:
V_data = '{"object": "listmembership","procedure": {"name": "filter_by_updated_at","arguments": {"updated_after": "2019-07-01 00:00:01","updated_before": "2020-04-15 00:00:01"}}}'
#Create Extract Request
response = requests.post('https://pi.pardot.com/api/export/version/4/do/create', headers=headers, params=params, data=V_data)
# Get assigned export id
response_dict=json.loads(response.text)
...
#Header to use:
V_data = '{"object": "visitorActivity","procedure": {"name": "filter_by_created_at","arguments": {"created_after": "2019-07-01 00:00:01","created_before": "2020-04-15 00:00:01"}}}'
#Create Extract Request
response = requests.post('https://pi.pardot.com/api/export/version/4/do/create', headers=headers, params=params, data=V_data)
# Get assigned export id
response_dict=json.loads(response.text)
