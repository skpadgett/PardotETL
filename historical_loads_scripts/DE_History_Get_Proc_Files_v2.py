...
for _file in exprt_status_dict['export']['resultRefs']:
    ...
    try:
        ...
        try:
            csvbucket.dump("propsects_hist/" + "propsects_" + writetime + ".csv", file1.content) #possibly file1.content
            sleep(1)
...
for _file in exprt_status_dict['export']['resultRefs']:
    ...
    try:
        ...
        writetime=time.strftime("%Y%m%d-%H%M%S")
        try:
            csvbucket.dump("prospectaccounts_hist/" + "prospectaccounts_" + writetime + ".csv", file1.content) #possibly file1.content
            sleep(1)
            print ('s3 success for visitors file ',i)
        except:
            print('Error posting to s3 for visitors file ',i,' ',_file)
...
for _file in exprt_status_dict['export']['resultRefs']:
    ...
    try:
        ...
        writetime=time.strftime("%Y%m%d-%H%M%S")
        try:
            csvbucket.dump("listmemberships_hist/" + "listmemberships_" + writetime + ".csv", file1.content) #possibly file1.content
            sleep(1)
            print ('s3 success for visitors file ',i)
        except:
            print('Error posting to s3 for visitors file ',i,' ',_file)
...
for _file in exprt_status_dict['export']['resultRefs']:
    ...
    try:
        ...
        writetime=time.strftime("%Y%m%d-%H%M%S")
        try:
            csvbucket.dump("visitoractivity_hist/" + "visitoractivity_" + writetime + ".csv", file1.content) #possibly file1.content
            sleep(1)
            print ('s3 success for visitors file ',i)
        except:
            print('Error posting to s3 for visitors file ',i,' ',_file)
