# Pardot Extract - emailclicks created_after='yesterday',created_before='today'
...
def emailclicks_func(event, context):
...
#################################################
    ...
    while i <=p.emailclicks.query(created_after='yesterday',created_before='today')['total_results'] -1: 
        data=p.emailclicks.query(format='json',sort_by='id',created_after='yesterday',created_before='today',id_greater_than=maxid)
